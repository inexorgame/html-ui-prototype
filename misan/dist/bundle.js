...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('app', '<video class="background-video" src="assets/inexor.mp4" autoplay loop></video> <main layout="row"> <navigation flex="15"></navigation> <section flex="85" class="ui" flex-offset="15"> <h1>{title}</h1> <article name="content"> </article> </section> </main>', '', '', function(opts) {
	    ...
	    this.on('mount', () => {
	        ...
	        riot.route((name) => {
	            this.title = name || 'player'
	            this.update()
	            riot.mount(this.content, name.toLowerCase(), {view: 'full'})
	        })
	    })
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('player', '<div layout="row" layout-align="space-between"> <div layout="column" class="name"> <span>Misan</span> <span>mX</span> </div> <img class="avatar" src="" alt=""> </div> <div layout="row" layout-align="space-between"> <div layout="column" layout-align="space-between center"> <span>Kills</span> <span style="font-size: 2em">129</span> </div> <div layout="column" layout-align="space-between center"> <span>Deaths</span> <span style="font-size: 2em">79</span> </div> <div layout="column" layout-align="space-between center"> <span>Efficiency</span> <span style="font-size: 2em">16%</span> </div> </div> <div layout="row" layout-align="space-between"> <div layout="column" layout-align="space-between center"> <span>Maps created</span> <span style="font-size: 2em">18</span> </div> <div layout="column" layout-align="space-between center"> <span>Games played</span> <span style="font-size: 2em">82</span> </div> <div layout="column" layout-align="space-between center"> <span>Servers</span> <span style="font-size: 2em">13</span> </div> </div> <div layout="row"> <div class="last server"> <h5>Last maps:</h5> <div layout="row" layout-wrap> <level map="+" mode="avatar"></level> <level mode="avatar" map="{map}" each="{map in maps}"></level> </div> </div> <img src="" alt=""> </div>', '', '', function(opts) {
	    this.maps = [
	        'arabic',
	        'xenon',
	        'tempest',
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag2('level', '<div layout layout-align="center center" class="level-avatar" if="{mode==\'avatar\'}"> <span>{map}</span> <video src="assets/inexor.mp4" autoplay loop></video> </div> <div class="level-detail" if="{mode==\'detail\'}"> </div>', '', '', function(opts) {
